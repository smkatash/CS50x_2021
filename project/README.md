...
My Final Project for CS50 is a web application using Flask, Python ans SQL based in part on the web track's distribution code.

The application is named CS50 Portfolio: to buy and sell Stock Shares.
The list will be only accesible to the user who will be asked to register with username and password. The user will be able to loginand logout.


The user will be able to buy and sell shares.
...
Project Video: https://youtu.be/eJzmj_-qz5M
